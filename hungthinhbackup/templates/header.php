...
fbq('init', '159103101175965');
fbq('track', "PageView");
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=159103101175965&ev=PageView&noscript=1"
/></noscript>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li <?php if ($menuActived == '') echo "class='active'";?>><a href="trang-chu.html">Trang chủ</a></li>
              ...
              <li class="<?php if ($menuActived == 'lienhe') echo "active";?>"><a class="no-after" href="lien-he.html">Liên hệ</a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li><a class="no-after" style="color: red; font-size: 15px;"><span class="glyphicon glyphicon-earphone" style="color: green;"></span> 0919.889.333</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>

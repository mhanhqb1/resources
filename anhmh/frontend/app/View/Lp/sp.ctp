...
<div id="topMenu" class="noselect">
    <a class="topMenuItem" href="#contact"><?php echo $this->Common->getlanguageLp('LP_MENU_CONTACT', $lpLang) ?></a>
    <a class="topMenuItem" href="#social"><?php echo $this->Common->getlanguageLp('LP_MENU_SOCIAL', $lpLang) ?></a>
    <a class="topMenuItem" href="#about"><?php echo $this->Common->getlanguageLp('LP_MENU_WHAT', $lpLang) ?></a>
</div>
...
<div id="section4">
    <img src="<?php echo BASE_URL ?>/img/landing/section4_sp.png"/>
</div>
...
<div id="section5">
    <div id="section5_container">
        ...
        <div id="section5_1" class="section5_item">
            <div class="section5_item_txt_step">
                <div class="section5_item_txt_step_row">
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_img">
                        <img src="<?php echo BASE_URL ?>/img/landing/step1_sp.png"/>
                    </div>
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_text">
                        <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_5_ITEM_TXT_STEP_1', $lpLang) ?>
                    </div>
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_right"></div>
                </div>
            </div>
        ...
        <div id="section5_2" class="section5_item">
            <div class="section5_item_txt_step">
                <div class="section5_item_txt_step_row">
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_img">
                        <img src="<?php echo BASE_URL ?>/img/landing/step2_sp.png"/>
                    </div>
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_text">
                        <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_5_ITEM_TXT_STEP_2', $lpLang) ?>
                    </div>
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_right"></div>
                </div>
            </div>
        ...
        <div id="section5_3" class="section5_item">
            <div class="section5_item_txt_step">
                <div class="section5_item_txt_step_row">
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_img">
                        <img src="<?php echo BASE_URL ?>/img/landing/step3_sp.png"/>
                    </div>
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_text">
                        <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_5_ITEM_TXT_STEP_3', $lpLang) ?>
                    </div>
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_right"></div>
                </div>
            </div>
        ...
        <div id="section5_4" class="section5_item">
            <div class="section5_item_txt_step">
                <div class="section5_item_txt_step_row">
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_img">
                        <img src="<?php echo BASE_URL ?>/img/landing/step4_sp.png"/>
                    </div>
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_text">
                        <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_5_ITEM_TXT_STEP_4', $lpLang) ?>
                    </div>
                    <div class="section5_item_txt_step_cell section5_item_txt_step_cell_right"></div>
                </div>
            </div>
    ...
    <div id="section5_bot">
        <?php if(!empty($lpLang2Digit) && $lpLang2Digit == 'en'): ?>
        <img src="<?php echo BASE_URL ?>/img/landing/section5_bot_sp_en.png"/>
        <?php elseif(!empty($lpLang2Digit) && $lpLang2Digit == 'es'): ?>
        <img src="<?php echo BASE_URL ?>/img/landing/section5_bot_sp_es.png"/>
        <?php else: ?>
        <img src="<?php echo BASE_URL ?>/img/landing/section5_bot_sp.png"/>
        <?php endif; ?>
    </div>
</div>
            ...
            <div class="section6_item_table">
                <div class="section6_item_row section6_item_row_1">
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            <div class="section6_item_img">
                                <img src="<?php echo BASE_URL ?>/img/landing/section6_1.png"/>
                            </div>
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_1_DIV', $lpLang) ?>
                            </div>
                        </div>
                    ...
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_2_DIV', $lpLang) ?>
                            </div>
                        </div>
                ...
                <div class="section6_item_row section6_item_row_2">
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_3_DIV', $lpLang) ?>
                            </div>
                        </div>
                    ...
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_4_DIV', $lpLang) ?>
                            </div>
                        </div>
                ...
                <div class="section6_item_row section6_item_row_3">
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_5_DIV', $lpLang) ?>
                            </div>
                        </div>
                    ...
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_6_DIV', $lpLang) ?>
                            </div>
                        </div>
                ...
                <div class="section6_item_row section6_item_row_4">
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_7_DIV', $lpLang) ?>
                            </div>
                        </div>
                    ...
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_8_DIV', $lpLang) ?>
                            </div>
                        </div>
                ...
                <div class="section6_item_row section6_item_row_5">
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_9_DIV', $lpLang) ?>
                            </div>
                        </div>
                    ...
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_10_DIV', $lpLang) ?>
                            </div>
                        </div>
                ...
                <div class="section6_item_row section6_item_row_6">
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_11_DIV', $lpLang) ?>
                            </div>
                        </div>
                    ...
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_12_DIV', $lpLang) ?>
                            </div>
                        </div>
                ...
                <div class="section6_item_row section6_item_row_7">
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_13_DIV', $lpLang) ?>
                            </div>
                        </div>
                    ...
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_14_DIV', $lpLang) ?>
                            </div>
                        </div>
                ...
                <div class="section6_item_row section6_item_row_8">
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_15_DIV', $lpLang) ?>
                            </div>
                        </div>
                    ...
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_16_DIV', $lpLang) ?>
                            </div>
                        </div>
                ...
                <div class="section6_item_row section6_item_row_9">
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_17_DIV', $lpLang) ?>
                            </div>
                        </div>
                    ...
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_18_DIV', $lpLang) ?>
                            </div>
                        </div>
                ...
                <div class="section6_item_row section6_item_row_10">
                    <div class="section6_item_cell">
                        <div class="section6_item_cell_container">
                            ...
                            <div class="section6_item_detail">
                                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_6_ITEM_DETAIL_19_DIV', $lpLang) ?>
                            </div>
                        </div>
    ...
    <div id="social_container">
        ...
        <div class="social_item">
            ...
            <div class="social_item_container">
                ...
                <div class="social_item_detail">
                    <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_7_ITEM_DETAIL_TXT_1', $lpLang) ?>
                </div>
            </div>
        </div>
        ...
        <div class="social_item social_item_2">
            ...
            <div class="social_item_container">
                ...
                <div class="social_item_detail">
                    <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_7_ITEM_DETAIL_TXT_2', $lpLang) ?>
                </div>
            </div>
        </div>
        ...
        <div class="social_item social_item_3">
            ...
            <div class="social_item_container">
                ...
                <div class="social_item_detail">
                    <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_7_ITEM_DETAIL_TXT_3', $lpLang) ?>
                </div>
            </div>
        </div>
    </div>
    <div id="social_bot">
        <img src="<?php echo BASE_URL ?>/img/landing/section7_bot_sp.png"/>
    </div>
</div>
...
<div id="section8">
    <div id="section8_container">
        ...
        <div id="section8_1_txt"><?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_8_1_TXT', $lpLang) ?></div>
        <div id="section8_txt">
            <div id="section8_2_txt">
                <?php echo $this->Common->getlanguageLp('LP_TXT_SECTION_8_2_TXT', $lpLang) ?>
            </div>
...
<div id="section9">
    <div id="section9_container">
        ...
        <form action="<?php echo BASE_URL ?>/ajax/sendLdContactMail/jp" id="contact-form" method="POST">
